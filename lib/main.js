(function() {
  var EventEmitter, coffee, defaultPipe, fs, initThread, mkdirp, p, through, walk, watch;
  ...
  module.exports = {
    ...
    watch: function(dir, output, callback) {
      ...
      return this.watchPipe(dir, callback).pipe(pipe);
    },
    watchPipe: function(dir, callback) {
      ...
      watcher.on('fileModified', function(file) {
        return _this.process(pipe, [file], callback);
      });
      return pipe;
    },
    build: function(dir, output, callback) {
      ...
      walker.on('end', function() {
        return _this.process(pipe, files, callback);
      });
      return pipe;
    }
  };
